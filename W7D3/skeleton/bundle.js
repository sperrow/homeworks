...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  var images = giphys.map(function (giph) {
    return _react2.default.createElement(
      'li',
      { key: giph.id },
      _react2.default.createElement('img', { src: giph.images.fixed_height.url })
    );
  });
  return _react2.default.createElement(
    'ul',
...
var GiphysIndexItem = function (_React$Component) {
  _inherits(GiphysIndexItem, _React$Component);

  function GiphysIndexItem() {
    _classCallCheck(this, GiphysIndexItem);

    return _possibleConstructorReturn(this, (GiphysIndexItem.__proto__ || Object.getPrototypeOf(GiphysIndexItem)).apply(this, arguments));
  }

  _createClass(GiphysIndexItem, [{
    key: 'render',
